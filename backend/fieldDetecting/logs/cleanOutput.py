#!/usr/bin/env python3
"""Clean backend fieldDetecting log artifacts."""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        description="Clean backend/fieldDetecting/logs artifacts."
    )
    parser.add_argument("--all", action="store_true", help="Clear all log files")
    parser.add_argument(
        "--dry-run",
        action="store_true",
