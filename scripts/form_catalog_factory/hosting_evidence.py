...
class FirebaseHostingClient:
    """Read the live Hosting release with the authenticated gcloud identity."""
...
def build_hosting_evidence(
    *,
    ...
    if not SOURCE_COMMIT_PATTERN.fullmatch(deployment_commit.lower()):
    ...
    return {
        ...
        "deploymentCommit": deployment_commit.lower(),
