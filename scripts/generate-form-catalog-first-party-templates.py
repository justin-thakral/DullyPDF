...
SECTIONS: tuple[SectionSpec, ...] = (
    ...
    SectionSpec(
        ...
        prefix="DHC",
        start_number=2600,
        label="Healthcare & Patient Operations",
        count=50,
        focuses=(
        ...
        requester_label="Patient / guardian / care contact",
        subject_label="Patient, visit, authorization, or care request",
        location_label="Clinic / provider / service location",
        checklist_options=(
            "Patient identity verified",
            "Insurance reviewed",
            "Consent required",
            "Records requested",
            "Provider follow-up needed",
            "Privacy review complete",
        ),
        status_options=("New", "Awaiting records", "Provider review", "Approved", "Closed"),
        table_columns=("Care item / document", "Provider", "Date", "Status", "Notes"),
    ),
    SectionSpec(
        section="small_business",
        prefix="DSB",
        start_number=2600,
        ...
        requester_label="Owner / employee / vendor contact",
        subject_label="Business operation, vendor, client, or approval request",
        location_label="Business / department / project",
        checklist_options=(
            "Budget reviewed",
            "Vendor details complete",
            "Manager approval needed",
            "Tax details requested",
            "Insurance verified",
            "Record updated",
        ),
        status_options=("Submitted", "Reviewing", "Approved", "In progress", "Closed"),
        table_columns=("Request / document / item", "Owner", "Amount", "Due date", "Notes"),
    ),
    SectionSpec(
        ...
        requester_label="Employee / manager / HR contact",
        subject_label="Employee, policy, leave, or workplace request",
        location_label="Department / work location",
        checklist_options=(
            "Manager review needed",
            "Payroll impact checked",
            "Policy reviewed",
            "Employee notified",
            "Documents attached",
            "HR record updated",
        ),
        status_options=("Submitted", "Manager review", "HR review", "Approved", "Archived"),
        table_columns=("Employee / task / document", "Owner", "Effective date", "Status", "Notes"),
    ),
    SectionSpec(
        section="finance_lending",
        prefix="DFL",
        start_number=2600,
        ...
        requester_label="Borrower / applicant / account contact",
        subject_label="Loan, credit, account, or borrower workflow",
        location_label="Branch / lender / account team",
        checklist_options=(
            "Identity verified",
            "Income documents requested",
            "Credit review needed",
            "Collateral details included",
            "Signature required",
            "Underwriting follow-up needed",
        ),
        status_options=("Started", "Documents pending", "Reviewing", "Approved", "Closed"),
        table_columns=("Document / account / item", "Amount", "Owner", "Due date", "Notes"),
    ),
    SectionSpec(
        section="hospitality_events",
        prefix="DHE",
        start_number=2600,
        ...
        requester_label="Guest / client / staff contact",
        subject_label="Reservation, event, guest, or service request",
        location_label="Venue / room / service area",
        checklist_options=(
            "Deposit reviewed",
            "Guest count confirmed",
            "Allergy notes included",
            "Vendor access scheduled",
            "Staff assigned",
            "Manager review needed",
        ),
        status_options=("Requested", "Confirmed", "In service", "Needs follow-up", "Closed"),
        table_columns=("Guest / service / item", "Quantity", "Owner", "Time", "Notes"),
    ),
    SectionSpec(
        section="retail_operations",
        prefix="DRO",
        start_number=2600,
        ...
        requester_label="Customer / associate / manager",
        subject_label="Store, order, product, or customer-service workflow",
        location_label="Store / register / warehouse",
        checklist_options=(
            "Receipt reviewed",
            "Manager approval needed",
            "Inventory adjusted",
        ...
        status_options=("Opened", "Reviewing", "Approved", "Completed", "Closed"),
        table_columns=("SKU / order / issue", "Quantity", "Associate", "Status", "Notes"),
    ),
    SectionSpec(
        section="utilities_energy",
        prefix="DUE",
        start_number=2600,
        ...
        requester_label="Customer / technician / utility contact",
        subject_label="Utility service, energy project, or field request",
        location_label="Service address / meter location",
        checklist_options=(
            "Account verified",
        ...
        status_options=("Requested", "Scheduled", "In progress", "Awaiting approval", "Complete"),
        table_columns=("Asset / measurement / task", "Reading", "Technician", "Date", "Notes"),
    ),
    SectionSpec(
        section="agriculture_food",
        prefix="DAF",
        start_number=2600,
        ...
        requester_label="Grower / manager / vendor contact",
        subject_label="Farm, food-safety, crop, livestock, or vendor workflow",
        location_label="Farm / field / facility / market",
        checklist_options=(
            "Lot or batch recorded",
            "Temperature logged",
            "Worker training verified",
            "Chemical details included",
            "Corrective action needed",
            "Traceability review complete",
        ),
        status_options=("Planned", "In progress", "Reviewing", "Corrective action", "Closed"),
        table_columns=("Lot / crop / task", "Quantity", "Owner", "Date", "Notes"),
    ),
    SectionSpec(
        section="legal_office",
        prefix="DLO",
        start_number=2600,
        label="Legal Office",
        count=50,
        ...
        requester_label="Client / attorney / staff contact",
        subject_label="Matter, filing, client, or legal-office request",
        location_label="Jurisdiction / office / meeting location",
        checklist_options=(
            ...
            "Fee or retainer reviewed",
            "File updated",
        ),
        status_options=("New", "Reviewing", "Waiting on client", "Ready to file", "Closed"),
        table_columns=("Document / task / party", "Owner", "Deadline", "Status", "Notes"),
    ),
    SectionSpec(
        section="home_services",
        prefix="DHS",
        ...
        requester_label="Homeowner / renter / property contact",
        subject_label="Home service, estimate, inspection, or completion request",
        location_label="Service address / access instructions",
        checklist_options=(
            "Access instructions provided",
            "Estimate approved",
            "Materials needed",
