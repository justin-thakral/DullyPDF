...
export const PUBLIC_SITE_FOOTER_SUMMARY =
  'DullyPDF turns recurring PDFs into reusable workflows: detect fields, refine the template, map data, collect responses, and produce the final document without rebuilding the process each time.';
