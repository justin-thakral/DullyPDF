...
- `/upload?catalogSlug=:slug` is the catalog-only anonymous editor handoff used by `Open in DullyPDF`; it fetches the public catalog PDF, clears the URL to `/ui`, and gates generated download/save actions behind login.
