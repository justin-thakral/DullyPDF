...
Generated PDF download quota copy should stay consistent across Profile, `/usage-docs/save-download-profile`, `/free-features`, `/premium-features`, and README surfaces: free includes 25 generated PDF downloads/month, premium includes unlimited generated PDF downloads, the counter resets by backend UTC month, and save/API/respondent/signing artifacts are governed by their own workflow limits.
