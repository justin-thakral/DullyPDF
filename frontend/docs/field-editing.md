...
- Fill By Link renders calculation `number_input` questions as integer inputs and rejects non-integer respondent answers before storing the response or materializing a respondent PDF download.
